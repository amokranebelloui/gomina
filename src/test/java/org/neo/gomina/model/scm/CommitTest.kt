...
class CommitTest {
    ...
    @Test
    fun test_match() {
        val c4 = Commit("56585", LocalDateTime.now(), author = "amokrane", message = "commit msg", version = "0.9.5-SNAPSHOT")
        val c3 = Commit("56583", LocalDateTime.now(), author = "amokrane", message = "commit msg", version = "0.9.5-SNAPSHOT")
        val c2 = Commit("56582", LocalDateTime.now(), author = "amokrane", message = "commit msg", version = "0.9.4")
