...
class DeploymentPipeline extends React.Component {
    render() {
        ...
        component.latest && (instancesByVersion[component.latest.version] = instancesByVersion[component.latest] || []);
        component.released && (instancesByVersion[component.released.version] = instancesByVersion[component.released] || []);
                ...
                <div style={{display: 'inline-block'}}>
                    {sortedVersions.map(version =>
                        <div key={version} style={{display: 'inline-block', verticalAlign: 'top', padding: '4px'}}>
                            <Version version={{version: version}} /><br/>
